To get Tensorflow Lite running on a ESP32 follow the tutorial to on how use the "Hello World" example on microcontrollers see: (how to setup hello world example and convert to C++.ipynb).
